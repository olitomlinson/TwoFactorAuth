...
namespace TwoFactorAuth.Domain.SpecFlowTests.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("codes_dont_cross_pollinate")]
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "codes_dont_cross_pollinate", "\tAs a PO/Customer\r\n\tI want 2fa codes to be isolated to an account\r\n\tSo that multi" +
...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("the correct code can be validated successfully, even when the user has received a" +
        ...
        public virtual void TheCorrectCodeCanBeValidatedSuccessfullyEvenWhenTheUserHasReceivedACodeForADifferentService()
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("the correct code can be validated successfully, even when the user has received a" +
                    " code for a different service", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 20
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("codes can\'t be used to validate other services, even if its for the same mobile n" +
            "umber")]
